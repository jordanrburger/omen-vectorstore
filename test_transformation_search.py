...
def main():
    """Run example transformation searches."""
    ...
    # Example 1: Search for transformations by functionality
    ...
    # Example 2: Search for specific code operations
    ...
    # Example 3: Find transformations related to a specific table
    print("\n=== Find transformations related to customer data ===")
    results = indexer.search_metadata(
        query="transformations using customer tables",
        embedding_provider=embedding_provider,
        metadata_type="transformations",
        limit=3
    )
    ...
    # Example 4: Search for specific transformation blocks
    print("\n=== Search for specific transformation blocks that load data ===")
    results = indexer.search_metadata(
